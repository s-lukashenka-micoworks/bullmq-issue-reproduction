import { Queue, SpanKind, TelemetryAttributes } from 'bullmq';
...
import { TelemetryAttributesPro } from '../enums/telemetry-pro.enum';
/**
...
export class QueuePro extends Queue {
    ...
    get metaValues() {
        ...
        return {
            ...
            version: `${this.libName}:${packageVersion}`,
        };
    }
    /**
     * Get library version.
        ...
        return this.trace(SpanKind.PRODUCER, 'add', `${this.name}.${name}`, async (span, srcPropagationMedatada) => {
            ...
            if (span) {
                ...
                if ((_b = opts === null || opts === void 0 ? void 0 : opts.group) === null || _b === void 0 ? void 0 : _b.id) {
                    span.setAttributes({
                        [TelemetryAttributesPro.GroupId]: opts.group.id,
                        [TelemetryAttributesPro.GroupMaxSize]: opts.group.maxSize,
                    });
                }
            }
            return job;
