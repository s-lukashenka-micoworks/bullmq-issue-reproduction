...
exports.FlowProducerPro = void 0;
...
class InterimFlowProducer extends bullmq_1.FlowProducer {
    async add(flow, opts) {
 ...
 */
class FlowProducerPro extends InterimFlowProducer {
    constructor(opts = { connection: {} }) {
        super(opts, redis_connection_pro_1.RedisConnectionPro);
    }
    get Job() {
     ...
     */
    async addBulk(flows) {
        return super.addBulk(flows);
    }
}
exports.FlowProducerPro = FlowProducerPro;
