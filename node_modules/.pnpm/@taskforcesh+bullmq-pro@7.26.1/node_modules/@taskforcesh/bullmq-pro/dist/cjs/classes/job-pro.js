...
class JobPro extends bullmq_1.Job {
    ...
    setScripts() {
        this.scripts = new scripts_pro_1.ScriptsPro(this.queue);
    }
    /**
    ...
    validateOptions(jobData) {
        ...
        if ((_a = this.opts.group) === null || _a === void 0 ? void 0 : _a.priority) {
            ...
            if (this.opts.group.priority > bullmq_1.PRIORITY_LIMIT) {
                throw new Error(`Group.priority should be between 0 and ${bullmq_1.PRIORITY_LIMIT}`);
            }
        }
    }
    /**
            ...
            if (nextBatch) {
                ...
                if (Array.isArray(nextBatch[0])) {
                    ...
                    for (let i = 0; i < rawJobs.length; i++) {
                        jobs.push((0, bullmq_1.array2obj)(rawJobs[i]));
                    }
                    return [
